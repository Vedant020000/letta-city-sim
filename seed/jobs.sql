...
VALUES
  ...
  (
    ...
    'Banker',
    'town',
    'Sets bank deposit and lending rates, watches reserves, and keeps credit flowing through town.',
    '{"typical_tasks": ["set rates", "review balance sheet", "explain loans"], "interfaces_with": ["bank_treasury", "shopkeeper", "student"], "guardrails": ["Keep loan and deposit rates within explicit tool limits."], "contributor_notes": "Core role for banking and money supply experiments."}'::jsonb,
    'bank_treasury', 600, 60, FALSE, 1
  ),
  (
    'bank_teller',
    'Bank Teller',
    'town',
    'Helps agents deposit, withdraw, and understand bank services.',
    '{"typical_tasks": ["help customers", "explain rates", "process deposits"], "interfaces_with": ["banker", "all_agents"], "guardrails": ["Do not set rates unless assigned banker authority."], "contributor_notes": "Support role for future bank staffing."}'::jsonb,
    'bank_treasury', 350, 60, FALSE, 2
  ),
  (
    'dispatcher',
    'Dispatcher',
